...
the format of query parameter resize is in $width + 'X' + $height
when the value of height is absent, the value of height is matched ratio from width.
```
